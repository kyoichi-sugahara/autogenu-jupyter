...
int main()
{
  ...
  cgmres::ZeroHorizonOCPSolver<cgmres::OCP_trajectory_following, kmax_init> initializer(
    ocp, settings);
  cgmres::Vector<1> uc0;
  uc0 << 0.0;
  ...
  cgmres::SingleShootingCGMRESSolver<cgmres::OCP_trajectory_following, N, kmax> mpc(

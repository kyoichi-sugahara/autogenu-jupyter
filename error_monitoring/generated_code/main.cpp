...
int main() {
  ...
  cgmres::ZeroHorizonOCPSolver<cgmres::OCP_generated_code, kmax_init>
  ...
  cgmres::MultipleShootingCGMRESSolver<cgmres::OCP_generated_code, N, kmax> mpc(
      ocp, horizon, settings);
  ...
  for (unsigned int i = 0; i < sim_steps; ++i) {
    // const reference to the initial optimal control input

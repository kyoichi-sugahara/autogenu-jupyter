...
#ifndef CGMRES__OCP_CARTPOLE_ERROR_MONITORING_HPP_ 
#define CGMRES__OCP_CARTPOLE_ERROR_MONITORING_HPP_ 
...
/// 
/// @class OCP_cartpole_error_monitoring
/// @brief Definition of the optimal control problem (OCP) of cartpole_error_monitoring.
/// 
class OCP_cartpole_error_monitoring { 
public:
  ///
  ...
  void disp(std::ostream& os) const {
    os << "OCP_cartpole_error_monitoring:" << std::endl;
    os << "  nx:  " << nx << std::endl;
    os << "  nu:  " << nu << std::endl;
    os << "  nc:  " << nc << std::endl;
    os << "  nh:  " << nh << std::endl;
  ...
  friend std::ostream& operator<<(std::ostream& os, const OCP_cartpole_error_monitoring& ocp) { 
    ocp.disp(os);
    return os;
  }

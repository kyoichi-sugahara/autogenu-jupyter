...
class Plotter(object):
    ...
    def __init__(self, log_dir, log_name: str):
        ...
        self.__relative_standard_deviation_data = np.genfromtxt(os.path.join(log_dir, log_name+'_relative_standard_deviation.log'))
        # Replace NaN with 0.
        ...
        self.__relative_standard_deviation_data[np.isnan(self.__relative_standard_deviation_data)] = 0
